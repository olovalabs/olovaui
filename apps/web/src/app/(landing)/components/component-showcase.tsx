  ...
  return (
    <section className="border-t border-border px-4 py-16 sm:px-6 lg:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-muted-foreground">
              Browse the components buyers expect to see before they trust a UI library: buttons, cards, inputs, dialogs, drawers, tabs, accordions, and animated patterns.
            </p>
          </div>
          <Link
            href="/components"
        ...
        <div className="mt-8 flex gap-2 overflow-x-auto pb-2 thin-scroll" role="tablist" aria-label="Component categories">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {!isReady ? (
            Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="h-64 animate-pulse rounded-lg bg-muted/20 border border-border" />
            ))
          ) : (
