  ...
  useEffect(() => {
    const addOpenGraphTags = () => {
      const ogTags = [
        ...
        { property: "og:site_name", content: "olova ui" },
        {
          property: "og:title",
          content:
        ...
        { property: "og:url", content: "https://olovaui.olova.net" },
        {
          property: "og:image",
          content: "https://olovaui.olova.net/og-image.png",
        },
        ...
        { property: "og:image:height", content: "630" },
        {
          ...
          content:
            "olova ui - Modern React Component Library with 500+ Animated Components",
        },
        ...
        { name: "twitter:site", content: "@liquid_ui" },
        { name: "twitter:creator", content: "@liquid_ui" },
        {
          name: "twitter:title",
          content: "olova ui - Modern React Component Library",
        },
        {
