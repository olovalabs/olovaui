...
import CodeCopy, { type LanguageType } from "./code-copy";
...
export const CodeBlockClient = ({
  ...
  const determineInitialLanguage = (l: BuiltinLanguage): LanguageType => {
  ...
  return (
    <div className="relative w-full">
      <div className="flex items-center justify-between px-4 py-2 bg-gradient-to-b from-muted/60 to-muted/30 supports-[backdrop-filter]:backdrop-blur border border-b-0 border-border rounded-t-lg shadow-sm">
      ...
      <div
        className={cn(
          "not-prose relative max-h-[500px] overflow-auto w-full rounded-b-lg border border-border",
