export const metadata = {
  title: "Beam Code Block - Olova UI",
  description:
  ...
  openGraph: {
    ...
    description:
      "A stunning, animated terminal-style code block with beam spotlight effects and spring-animated tab navigation.",
    type: "article",
    url: "/docs/code-block/beam-code-block",
  },
  alternates: {
    canonical: "/docs/code-block/beam-code-block",
  },
};

import BeamCodeBlockView from "./index";
...
```tsx
import { BeamCodeBlock } from "@/components/beam-code-block";
