export const metadata = {
  title: "Code Block - Olova UI",
  description:
    "A collection of animated and utility-first code block components for install commands, terminal snippets, and interactive command switching.",
  keywords: [
    "code block",
    "react code block",
    "terminal ui",
  ...
  openGraph: {
    title: "Code Block - Olova UI",
    description:
      "Explore simple, natural, select, beam, and glitch code block components in one unified docs page.",
    type: "article",
    url: "/docs/code-block",
  },
  alternates: {
    canonical: "/docs/code-block",
  },
};

import CodeBlockSimpleView from "./code-block-simple/code-block-simple-view";
import CodeBlockNatural from "./code-block-natural/code-block-natural";
import CodeBlockSelectView from "./code-block-select/code-block-select-view";
import BeamCodeBlockView from "./beam-code-block/index";
import GlitchBlockView from "./glitch-block/index";
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<BeamCodeBlockView />} reTrigger={true} />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/docs/code-block/beam-code-block/beam-code-block.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<GlitchBlockView />} reTrigger={true} />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/docs/code-block/glitch-block/glitch-block.tsx" />
  </TabsContent>
</Tabs>
