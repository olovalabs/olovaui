...
const PnpmIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M30,10.75H21.251V2H30Z" style={{ fill: "currentColor" }} />
    <path d="M20.374,10.75h-8.75V2h8.75Z" style={{ fill: "currentColor" }} />
    <path d="M10.749,10.75H2V2h8.749Z" style={{ fill: "currentColor" }} />
    <path d="M30,20.375H21.251v-8.75H30Z" style={{ fill: "currentColor" }} />
    <path
      d="M20.374,20.375h-8.75v-8.75h8.75Z"
      style={{ fill: "currentColor" }}
    />
    <path d="M20.374,30h-8.75V21.25h8.75Z" style={{ fill: "currentColor" }} />
    <path d="M30,30H21.251V21.25H30Z" style={{ fill: "currentColor" }} />
    <path d="M10.749,30H2V21.25h8.749Z" style={{ fill: "currentColor" }} />
  </svg>
);

// Using grayscale filter for Bun to maintain the illustration details without color
const BunIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 128 128"
    className={`${className} grayscale dark:brightness-150 dark:contrast-125`}
  >
...
export function CodeBlockCommand({
  ...
  const [activeTab, setActiveTab] = useState<"pnpm" | "yarn" | "npm" | "bun">(
    "pnpm"
  );
  ...
  const handleCopy = () => {
    const textToCopy = commands[activeTab].cmd;
  ...
  const ActiveIcon = commands[activeTab].icon;

  return (
    <div className="flex w-full items-center justify-center p-8 font-sans text-foreground">
      <div className="w-full max-w-3xl">
        <div className="relative overflow-hidden rounded-xl border border-border bg-card shadow-2xl">
          <div className="flex items-center justify-between border-b border-border/50 bg-card px-4 pt-3">
            <div className="flex items-center gap-6">
              <div className="flex items-center justify-center text-foreground transition-all duration-300">
                ...
                {(Object.keys(commands) as Array<keyof typeof commands>).map(
                  (manager) => (
                    ...
                    >
                      {manager}
                      {activeTab === manager && (
                        <span className="absolute bottom-0 left-0 h-[2px] w-full bg-primary shadow-[0_0_8px_rgba(0,0,0,0.2)] dark:shadow-[0_0_8px_rgba(255,255,255,0.5)]" />
                      )}
                    </button>
                  )
                )}
            ...
            <div className="pb-2">
              <button
                onClick={handleCopy}
                className="group relative flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground transition-all hover:bg-accent hover:text-accent-foreground"
          ...
          <div className="group relative bg-muted/40 p-6 font-mono text-sm">
            <div className="flex min-h-[52px] w-full overflow-x-auto pb-2">
              <span className="mr-2 select-none text-muted-foreground">$</span>
              <span className="text-foreground selection:bg-muted-foreground/30 whitespace-pre">
