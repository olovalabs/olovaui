export const metadata = {
  title: "Olova UI - Enterprise-Grade React Component Library Documentation",
  description:
    "Olova UI offers a suite of beautifully designed, accessible, and highly customizable React components built with Tailwind CSS and Framer Motion for modern web development.",
  keywords: [
    "Olova UI",
  ...
  openGraph: {
    title: "Olova UI - Enterprise-Grade React Component Library",
    description:
      "Empower your web applications with Olova UI. A collection of accessible, performant, and customizable React components designed for the modern web.",
    type: "website",
    url: "/docs",
    images: [
      {
...
1.  **Component Selection**: Navigate our extensive documentation to identify the components that meet your application's requirements.
2.  **Source Code Integration**: Access the full source code for any component directly from the browser.
3.  **Local Implementation**: Copy the code into your project's directory structure. This approach grants you full ownership of the component logic, enabling deep customization without upstream dependency constraints.
