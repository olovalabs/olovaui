export const metadata = {
  title: "Letter Glitch Text Animation | Olova UI",
  description:
    "A terminal-inspired letter glitch component that scrambles characters before resolving into readable text.",
  keywords: [
    "letter glitch",
    "glitch text",
    "terminal animation",
  ...
  openGraph: {
    ...
    description:
      "A terminal-inspired letter glitch component that scrambles characters before resolving into readable text.",
    type: "article",
    url: "/docs/text/letter-glitch",
  },
  alternates: {
    canonical: "/docs/text/letter-glitch",
  },
};

import { LetterGlitchView } from "./index.tsx";
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<LetterGlitchView />} reTrigger={true} />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/docs/text/letter-glitch/index.tsx" />
  </TabsContent>
</Tabs>
