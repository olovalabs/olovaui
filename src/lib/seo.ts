...
export function generateMetadata(config: SEOConfig): Metadata {
  ...
  const fullTitle = title.includes('Olova UI') ? title : `${title} | Olova UI`
  ...
  return {
    ...
    other: {
      ...
      'apple-mobile-web-app-title': 'Olova UI',
      'application-name': 'Olova UI',
  ...
  switch (type) {
    case 'component':
      return {
        ...
        codeRepository: 'https://github.com/olova.net/olovaui',
